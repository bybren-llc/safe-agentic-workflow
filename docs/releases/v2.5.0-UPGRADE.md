...
git checkout harness/main -- .claude/skills/*/SKILL.md

# For new files (safe to copy):
git checkout harness/main -- .claude/skills/team-coordination/
git checkout harness/main -- .claude/settings.template.json
git checkout harness/main -- docs/onboarding/AGENT-TEAMS-GUIDE.md
git checkout harness/main -- docs/guides/OPTIONAL-FEATURES.md
